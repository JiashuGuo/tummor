...
def generate_piecewisecurve():
    from __main__ import freq, mis, num_classes, test_ts, randomSeed
    #freq = 700
    #mis = range(1,101,20) 
    #num_classes=5
    seed(randomSeed)
    ...
    while len(testList) < 500:
        ...
        pieceLabel = np.reshape(pieceLabel, (int(pieceLabel.shape[0]/2), 2, num_classes))
